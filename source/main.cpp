...
const static char DEVICE_NAME[] = "Eric Device";
...
{
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) : _ble(ble),
                                                               ...
                                                               _magnetometer_data{0},
                                                               _MAG_SERVICE_UUID(0xAABB),
                                                               _magnetometer_service(ble, _magnetometer_data)
    {
    }
...
private:
    ...
    void start_advertising()
    {
        ...
        _adv_data_builder.setLocalServiceList({&_MAG_SERVICE_UUID, 1});
    ...
    void update_sensor_value()
    {
        ...
        /* Update magneto*/
        BSP_MAGNETO_GetXYZ(_magnetometer_data);
        _magnetometer_service.updateMagData(_magnetometer_data);
    }
...
private:
    ...
    UUID _MAG_SERVICE_UUID;
    MagService _magnetometer_service;
    int16_t _magnetometer_data[3];
};
