#ifndef __MAGNETO_SERVICE_SERVICE_H__
#define __MAGNETO_SERVICE_SERVICE_H__
...
protected:
  /**
   * Construct and add to the GattServer
   */
  void setupService()
  {
