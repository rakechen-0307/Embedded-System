...
public:
    MagnetoDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _uuid(GattService::UUID_HEART_RATE_SERVICE),
        _mag_value(),
        _mag_service(ble, _mag_value),
...
private:
    ...
    void start_advertising()
    {
        ...
        _adv_data_builder.setLocalServiceList({&_uuid, 1});
    ...
    {
        BSP_MAGNETO_GetXYZ(_mag_value);
        _mag_service.updateMagData(_mag_value);
    }
...
private:
    ...
    UUID _uuid;
    int16_t _mag_value[3];
    MagnetoService _mag_service;
