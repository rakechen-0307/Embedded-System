...
int FloatToRecWidth(float value)
{
	if (value < 0.0f)
	{
		return 0;
	...
	return (int)(value * 220 / 6.28);
}

void DrawRec(float value)
{
	int w = FloatToRecWidth(value);
	ST7789_DrawFilledRectangle(10, 50, w, 36, RED);
	ST7789_DrawFilledRectangle(10 + w, 50, 220 - w, 36, WHITE);
}
